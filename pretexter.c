    ...
    */
    ...
    fprintf(fh,"<script language=\"javascript\">\n function show() { window.status=\"Created with PreTexter V 1.0 By Bhupal Sapkota\"} </script> ");
    fprintf(fh,"</head>");
    fprintf(fh,"\n<body>\n<pre>");
    //fprintf(fh,"\n");
    ...
    //END of HTMl File
    //fprintf(fh,"\n");
    fprintf(fh,"\n<center><a onmouseover=show() href=\"http://www.bhupalsapkota.com.np/index.php?wh=res\">Bhupal</a></center>\n</pre>\n</body>\n</html>");
